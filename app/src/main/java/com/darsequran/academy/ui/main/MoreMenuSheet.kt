...
fun MoreMenuSheet(
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = "Student Features & Services",
            ...
            MoreMenuItem(
                ...
                title = "Cart & Book Store",
                subtitle = "View selected courses & Islamic literature",
                onClick = onSelectCart
            )

            Spacer(modifier = Modifier.height(12.dp))

            // Option 3: Fee Waiver Program
            MoreMenuItem(
                icon = Icons.Default.Star,
                title = "Fee Waivers & Financial Aid",
                subtitle = "Apply for student fee assistance program",
                onClick = {}
            )
